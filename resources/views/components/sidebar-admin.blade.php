      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <form method="POST" action="{{ route('logout') }}" style="display: inline;">
               @csrf
               <button type="submit" class="flex items-center p-2 text-gray-900 content-center rounded-lg hover:text-white text-gray-900 hover:bg-blue-600 group transform transition duration-300 ease-in-out hover:scale-100 hover:translate-x-1">
