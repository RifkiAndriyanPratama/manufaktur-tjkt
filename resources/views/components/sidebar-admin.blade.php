...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-gray-200 border-r border-gray-200 sm:translate-x-0 z-20" aria-label="Sidebar">
   ...
   <hr class="border-gray-600 mb-2 flex-shrink-0" />
      <ul class="space-y-2 font-medium">
         <li>
            <a href="{{ route('admin.management') }}" class="flex items-center p-2 text-gray-900 content-center rounded-lg hover:text-white text-gray-900 hover:bg-blue-600 group transform transition duration-300 ease-in-out hover:scale-100 hover:translate-x-1 {{ Request::is('admin') ? 'bg-blue-600 text-white scale-100 translate-x-1' : '' }}">
            ...
            <span class="flex-shrink-0 ms-2 ml-4 text-base transition-opacity duration-300">Statistik</span>
            </a>
         </li>
         <li>
            <a href="{{ route('barang.index') }}" class="flex items-center p-2 text-gray-900 content-center rounded-lg hover:text-white text-gray-900 hover:bg-blue-600 group transform transition duration-300 ease-in-out hover:scale-100 hover:translate-x-1 {{ Request::is('barang') ? 'bg-blue-600 text-white scale-100 translate-x-1' : '' }}">
         ...
         <li>
            <a href="{{ route('kategori.index') }}" class="flex items-center p-2 text-gray-900 content-center rounded-lg hover:text-white text-gray-900 hover:bg-blue-600 group transform transition duration-300 ease-in-out hover:scale-100 hover:translate-x-1 {{ Request::is('kategori') ? 'bg-blue-600 text-white scale-100 translate-x-1' : '' }}">
                <svg class="flex-shrink-0 w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 18 20">
         ...
         <li>
            <a href="{{ route('kelas.index') }}" class="flex items-center p-2 text-gray-900 content-center rounded-lg hover:text-white text-gray-900 hover:bg-blue-600 group transform transition duration-300 ease-in-out hover:scale-100 hover:translate-x-1 {{ Request::is('kelas') ? 'bg-blue-600 text-white scale-100 translate-x-1' : '' }}">
