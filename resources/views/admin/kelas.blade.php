                    ...
                    <div class="bg-white rounded-lg shadow-lg w-1/3">
                        ...
                        <form action="{{ route('kelas.update', $item->id_kelas) }}" method="POST" class="p-4">
                            ...
                            <div class="flex justify-end py-4 px-4">
                                <button type="button" onclick="document.getElementById('editModal-{{ $item->id_kelas }}').classList.add('hidden')" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">Batal</button>
                    ...
                    <div class="bg-white rounded-lg shadow-lg w-1/3">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-end mt-4">
                                <button onclick="document.getElementById('deleteModal-{{ $item->id_kelas }}').classList.add('hidden')" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">Batal</button>
    ...
    <div id="addModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 hidden flex items-center justify-center">
        <div class="bg-white rounded-lg shadow-lg w-1/3">
            ...
            <form action="{{ route('kelas.store') }}" method="POST" class="p-4">
                ...
                <div class="mb-4">
                    <label for="nama_kelas" class="block text-gray-700">Nama kelas</label>
                    <input type="text" name="nama_kelas" class="border rounded px-4 py-2 w-full" required>
                </div>
