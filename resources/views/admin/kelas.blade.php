...
<div class="container mx-auto py-0">
    ...
    <form action="{{ route('kelas.index') }}" method="GET" class="mb-4">
        <div class="relative">
            <input id="search" type="text" name="search" value="{{ request('search') }}" class="w-full border border-gray-300 rounded-lg p-2 pl-10" placeholder="Cari kelas">
