<x-layout-admin>
<div class="absoluted text-white p-0 flex justify-around gap-4 w-full h-screen">
    <!-- Jumlah Barang -->
    <div class="bg-gray-100 w-1/4 h-1/4 flex flex-col items-center justify-center rounded-lg shadow-md hover:scale-105 transition-transform duration-200">
