    ...
    <div>
        <div>
            <div class="flex justify-end gap-2">
                <div class="py-4">
                    <a href="{{ route('exportPdf') }}" class="p-2 bg-red-600 rounded-lg text-white flex items-center gap-2">
                ...
                <div class="py-4">
                    <a href="{{ route("excel") }}" class="p-2 bg-green-600 rounded-lg text-white flex items-center gap-2">
